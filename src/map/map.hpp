...
inline bool mapdata_flag_vs(struct map_data *mapdata) {
	...
	if (mapdata->flag[MF_PVP] || mapdata->flag[MF_PVP2] || mapdata->flag[MF_PVP3] || mapdata->flag[MF_GVG_DUNGEON] || mapdata->flag[MF_GVG] || ((agit_flag || agit2_flag) && mapdata->flag[MF_GVG_CASTLE]) || mapdata->flag[MF_GVG_TE] || (agit3_flag && mapdata->flag[MF_GVG_TE_CASTLE]) || mapdata->flag[MF_BATTLEGROUND])
		return true;
...
inline bool mapdata_flag_vs2(struct map_data *mapdata) {
	...
	if (mapdata->flag[MF_PVP] || mapdata->flag[MF_PVP2] || mapdata->flag[MF_PVP3] || mapdata->flag[MF_GVG_DUNGEON] || mapdata->flag[MF_GVG] || mapdata->flag[MF_GVG_CASTLE] || mapdata->flag[MF_GVG_TE] || mapdata->flag[MF_GVG_TE_CASTLE] || mapdata->flag[MF_BATTLEGROUND])
		return true;
...
inline bool mapdata_flag_ks(struct map_data *mapdata) {
	...
	if (mapdata->flag[MF_TOWN] || mapdata->flag[MF_PVP] || mapdata->flag[MF_PVP2] || mapdata->flag[MF_PVP3] || mapdata->flag[MF_GVG] || mapdata->flag[MF_GVG_TE] || mapdata->flag[MF_BATTLEGROUND])
		return true;
